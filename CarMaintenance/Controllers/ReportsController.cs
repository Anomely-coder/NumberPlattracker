...
namespace CarMaintenance.Controllers
{
    public class ReportsController : Controller
    {
        ...
        public IActionResult Search(string searchTerm)
        {
            ...
            // If no search term is provided, return an empty result set
        ...
        // Helper method to get the generated by username
        ...
        public IActionResult ExportPdf(string searchTerm)
        {
            ...
            // If no search term is provided, return an empty PDF or an error
            if (string.IsNullOrEmpty(searchTerm))
            {
